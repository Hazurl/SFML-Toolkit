...
std::ostream& operator<<(std::ostream& os, sf::ContextSettings const& c) {
	return os << "Settings {v=" << c.majorVersion << "." << c.minorVersion << ", attrs=" << c.attributeFlags << ", rgb=" << std::boolalpha
			  << c.sRgbCapable << ", " << c.depthBits << "/" << c.stencilBits << "/" << c.antialiasingLevel << "}";
}

std::ostream& operator<<(std::ostream& os, sf::Event const& e) {
	switch (e.type) {
		case sf::Event::Closed: return os << "Event Close";
		case sf::Event::Resized: return os << "Event " << e.size;
		case sf::Event::LostFocus: return os << "Event Lose Focus";
		case sf::Event::GainedFocus: return os << "Event Gain Focus";
		case sf::Event::TextEntered: return os << "Event " << e.text;
		case sf::Event::KeyPressed: return os << "Event Press " << e.key;
		case sf::Event::KeyReleased: return os << "Event Release " << e.key;
		case sf::Event::MouseWheelScrolled: return os << "Event " << e.mouseWheelScroll;
		case sf::Event::MouseButtonPressed: return os << "Event Press " << e.mouseButton;
		case sf::Event::MouseButtonReleased: return os << "Event Release " << e.mouseButton;
		case sf::Event::MouseMoved: return os << "Event " << e.mouseMove;
		case sf::Event::MouseEntered: return os << "Event Enter Mouse";
		case sf::Event::MouseLeft: return os << "Event Leave Mouse";
		case sf::Event::JoystickButtonPressed: return os << "Event Press " << e.joystickButton;
		case sf::Event::JoystickButtonReleased: return os << "Event Release " << e.joystickButton;
		case sf::Event::JoystickMoved: return os << "Event Move Joystick " << e.joystickMove;
		case sf::Event::JoystickConnected: return os << "Event Connect Joystick {id=" << e.joystickConnect.joystickId << "}";
		case sf::Event::JoystickDisconnected: return os << "Event Disconnect Joystick {id=" << e.joystickConnect.joystickId << "}";
		case sf::Event::TouchBegan: return os << "Event Begin " << e.touch;
		case sf::Event::TouchMoved: return os << "Event Move " << e.touch;
		case sf::Event::TouchEnded: return os << "Event End " << e.touch;
		case sf::Event::SensorChanged: return os << "Event " << e.sensor;
...
std::ostream& operator<<(std::ostream& os, sf::Joystick::Axis const& a) {
	switch (a) {
		case sf::Joystick::Axis::X: return os << "Axis X";
		case sf::Joystick::Axis::Y: return os << "Axis Y";
		case sf::Joystick::Axis::Z: return os << "Axis Z";
		case sf::Joystick::Axis::R: return os << "Axis R";
		case sf::Joystick::Axis::U: return os << "Axis U";
		case sf::Joystick::Axis::V: return os << "Axis V";
		case sf::Joystick::Axis::PovX: return os << "Axis PovX";
		case sf::Joystick::Axis::PovY: return os << "Axis PovY";
		default: return os << "Axis Unknown";
	}
}
...
std::ostream& operator<<(std::ostream& os, sf::Mouse::Button const& b) {
	switch (b) {
		case sf::Mouse::Button::Left: return os << "Button Left";
		case sf::Mouse::Button::Right: return os << "Button Right";
		case sf::Mouse::Button::Middle: return os << "Button Middle";
		case sf::Mouse::Button::XButton1: return os << "Button XButton1";
		case sf::Mouse::Button::XButton2: return os << "Button XButton2";
		default: return os << "Button Unknown";
	}
}
...
std::ostream& operator<<(std::ostream& os, sf::Mouse::Wheel const& w) {
	switch (w) {
		case sf::Mouse::Wheel::VerticalWheel: return os << "Wheel VerticalWheel";
		case sf::Mouse::Wheel::HorizontalWheel: return os << "Wheel HorizontalWheel";
		default: return os << "Wheel Unknown";
	}
}
...
std::ostream& operator<<(std::ostream& os, sf::Sensor::Type const& s) {
	switch (s) {
		case sf::Sensor::Type::Accelerometer: return os << "Sensor Accelerometer";
		case sf::Sensor::Type::Gyroscope: return os << "Sensor Gyroscope";
		case sf::Sensor::Type::Magnetometer: return os << "Sensor Magnetometer";
		case sf::Sensor::Type::Gravity: return os << "Sensor Gravity";
		case sf::Sensor::Type::UserAcceleration: return os << "Sensor UserAcceleration";
		case sf::Sensor::Type::Orientation: return os << "Sensor Orientation";
		default: return os << "Sensor Unknown";
	}
}
