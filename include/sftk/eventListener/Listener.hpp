...
struct select_invocable<Listener<T, Ts...>, std::enable_if_t<!std::is_invocable_v<T, sf::Window&, Es const&...>>, Es...>
...
struct select_invocable<Listener<>, void, Es...> {
